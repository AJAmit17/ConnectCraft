...
const LeftSideBar = () => {
  ...
  return (
    <section className='bg-muted sticky left-0 top-0 flex h-screen flex-col justify-between overflow-y-auto p-6 pt-36 shadow-white-300 dark:shadow-none max-sm:hidden lg:w-[266px]'>
